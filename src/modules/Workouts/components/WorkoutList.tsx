...
import { useGetWorkoutSummaries } from '../api/workout.hooks'
...
export default function WorkoutList() {
  ...
  const { isLoading, data: workouts } = useGetWorkoutSummaries()
          ...
          {workouts?.map((workout) => (
            <Card key={workout.id} withBorder>
              ...
              <Text size="sm" c="dimmed" mb="md">
                {dayjs(workout.startTime).format('MMM D, YYYY h:mm A')}
              </Text>
